...
class AchievementScreenMessage(BaseObject):
    """
    Creates message to show user they have reached achievement screen
    """
    ...
    def __init__(self, il, x=300, y= 120):
        ...
        self.game_message = self.font.render("This is the Achievements Screen", True, (255, 255, 255))
