...
class OptionsScene(SceneBase):
        ...
        for event in events:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if 450 < location [0] < 550 and 700 < location[1] < 740:
                    self.change_resolution_bool = True
                    print(self.new_resolution)
    ...
    def render(self, screen):
        if self.new_resolution is not None and self.change_resolution_bool:
            screen = pygame.display.set_mode(self.new_resolution)
            self.change_resolution_bool = False
