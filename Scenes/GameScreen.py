...
from Objects.GameScreenObjects import BackgroundImage, GameScreenMessage, GameScreenStatusMenu
...
class GameScreen(SceneBase):
    def __init__(self, il):
        ...
        self.OH.new_object(GameSceneManager(self.IL, self.status_menu, self.player_board, self.enemy_board))
